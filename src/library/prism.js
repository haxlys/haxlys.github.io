...
var Prism$2 = {
  render: function render() {
    ...
    return _c('pre',
      ...
      [_c('code',
        ...
        [_vm._v(_vm._s(_vm.code)), !_vm.code ? _vm._t("default") : _vm._e()], 2)]
    );
  }, staticRenderFns: [],
  props: {
    language: {
  ...
  methods: {
    render: function render() {
      ...
      this.codeText = this.code || this.$refs.pre.textContent;
      // this.$refs.pre.firstChild.innerHTML = this.codeText;
      this.$refs.pre.firstChild.innerHTML = Prism.highlight(this.codeText, Prism.languages[this.language]);
      //Prism.highlightElement(this.$refs.pre.firstChild);
      if (this.plugins.length > 0) Prism.highlightElement(this.$refs.pre.firstChild);
    },
